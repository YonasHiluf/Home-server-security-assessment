...
basic risks, apply hardening steps, and produce a before/after report.

## Scope
Own devices and authorized environments only.
...
- Linux built-in logs — auth and service review
